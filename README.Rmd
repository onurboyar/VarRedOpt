...
simulate.outer(n=1e5, d=3, q.outer = myq_asian,
               K = K, ti = ti, r = 0.03, sigma = 0.3, S0 = 100)
...
simulate.outer(n=1e5, d=3, q.outer = sim.AV, 
               q.av = myq_asian,K = K, ti = ti, r = 0.03, sigma = 0.3, S0 = 100)
```
...
simulate.outer(n=1e5, d=3, q.outer = sim.InnerCV, 
               q.cv = myq_asian,K = K, ti = ti, r = 0.03, sigma = 0.3, S0 = 100)
```
...
```{r example}
simulate.outer(n, d, q.outer = sim.AV, q.av = sim.GeometricAvg, 
               q.ga = myq_asian,K = K, ti = ti, r = 0.03, sigma=0.3, S0=100)
```
